<template>
  <div>
    <el-tabs type="border-card" v-model="targerName">
      <el-tab-pane label="税务支出" name="first">
        <el-form
          class="dz-toolbar"
          ref="searchForm"
          :inline="true"
...
<!--           </el-form-item>-->
        ...
        <el-col :span="24">
          <div class="fl">
            <el-button type="primary" @click="addPlan" class="reateBtn" v-if="permButton('71010501')">创建税务支出</el-button>
            <el-button type="primary" @click="importExcel" class="reateBtn" v-if="permButton('71010508')">导入</el-button>
          </div>
        </el-col>
...
<!--          </el-table-column>-->
          <el-table-column label="操作" width="250px" fixed="right" align="center">
            <template slot-scope="scope">
              <el-button size="small" type="text" @click="check(scope.row)"  v-if="permButton('71010502')">查看</el-button>
              <el-button size="small" type="text" @click="update(scope.row)"  v-if="permButton('71010503')">编辑</el-button>
              <el-button
              ...
              ><span v-if="permButton('71010507')">设置失效</span></el-button>
              <el-button @click="validChange(scope.row)" v-else size="small" type="text"><span v-if="permButton('71010507')">设置有效</span></el-button>
            </template>
          </el-table-column>
        </el-table>
        <Pager
...
import { taxExpenditurePage, taxExpenditureEffectiveness } from "@/api/taxExpenditure";
...
export default {
  ...
  data() {
    return {
      ...
      upLoad:[],
      uploadPath: '/api/dispatch/pc/71010508',
      importTitle: '批量导入税务支出',
      // templateId: '4ef02e18535246ea91c0ff212f771da3',//正式环境140
       templateId: '658cbfe769be43b8b2e798fc89d2195a',
      fileDialog:false,
      searchParams: {
        page: 1,
        size: 10,
  ...
  methods: {
    ...
    validChange(v) {
      ...
      vm.$confirm(
        ...
        try {
          await taxExpenditureEffectiveness(vm.isValidParams);
    ...
    async fetchTableData() {
      ...
      try {
        ...
        let data = await taxExpenditurePage(vm.searchParams);
        console.log(data);
