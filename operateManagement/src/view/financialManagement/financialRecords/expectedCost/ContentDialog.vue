      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="预期金额：" prop="expectedAmount">
            <el-input v-model.number="searchParams.expectedAmount" placeholder="请输入金额"></el-input>
          </el-form-item>
        </el-col>
<!--        <el-col :span="12">-->
...
<!--        </el-col>-->
    ...
    <el-row slot="footer" class="dz-dialog-footer">
      <el-button
        ...
        type="primary"
        @click="handleAdd()"
        v-if="dialogHandleType === 'add' && permButton('71010701')"
      >确认创建</el-button>
      <el-button
        class="button"
        type="primary"
        @click="handleEdit()"
        v-if="dialogHandleType === 'edit' && permButton('71010703')"
      >保存修改</el-button>
    </el-row>
  </el-dialog>
</template>
...
import { expectedCost, expectedCostEdit } from "@/api/expectedCost";
  ...
  methods: {
    ...
    handleAdd() {
      ...
      vm.$refs.searchParams.validate().then(async () => {
        ...
        await expectedCost(vm.searchParams);
        vm.loading = false;
    ...
    handleEdit() {
      ...
      vm.$refs.searchParams.validate().then(async () => {
        ...
        await expectedCostEdit(vm.searchParams);
        vm.loading = false;
