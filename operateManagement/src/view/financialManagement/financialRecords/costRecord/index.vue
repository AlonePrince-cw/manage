<template>
  <div>
    <el-tabs type="border-card" v-model="targerName">
      <el-tab-pane label="成本记录" name="first">
        <el-form
          class="dz-toolbar"
          ref="searchForm"
          :inline="true"
        ...
        >
          ...
          <el-form-item label="金额范围:" class="meneyArea">
            <el-input v-model="searchParams.occurStartAmount" placeholder="请输入金额"></el-input>
            <span>-</span>
            <el-input v-model="searchParams.occurEndAmount" placeholder="请输入金额"></el-input>
          </el-form-item>
        ...
        <el-col :span="24">
          <div class="fl">
            <el-button type="primary" @click="addPlan" class="reateBtn" v-if="permButton('71010401')">创建成本记录</el-button>
            <el-button type="primary" @click="importExcel" class="reateBtn" v-if="permButton('71010408')">导入</el-button>
          </div>
        </el-col>
        <el-table border :data="expenseRecordData">
           <el-table-column label="财务状态" :show-overflow-tooltip="true" width="150px" prop="financialStatus" align="center">
...
<!--          ></el-table-column>-->
         ...
         <template slot-scope="scope">
          ...
          <el-table-column label="操作" width="250px" fixed="right" align="center">
            <template slot-scope="scope">
              <el-button size="small" type="text" @click="check(scope.row)" v-if="permButton('71010402')">查看</el-button>
              <el-button size="small" type="text" @click="update(scope.row)" v-if="permButton('71010403')">编辑</el-button>
              <el-button
              ...
              ><span v-if="permButton('71010407')">设置失效</span></el-button>
              <el-button @click="validChange(scope.row)" v-else size="small" type="text"><span v-if="permButton('71010407')">设置有效</span></el-button>
            </template>
          </el-table-column>
        </el-table>
        <Pager
...
import { costPage, costEffectiveness } from "@/api/costRecord";
...
export default {
  ...
  data() {
    return {
      ...
      fileDialog:false,
      upLoad:[],
      uploadPath: '/api/dispatch/pc/71010408',
      importTitle: '批量导入成本记录',
      // templateId: '149365da6caa47b7861fd7a8f66776d6',//正式环境140
      templateId: '490c04c947a148b9ac2ab3689811c910',
      searchParams: {
        page: 1,
        size: 10,
        total: 0,
        ...
        occurEndTime:"",//发生结束时间
        occurStartAmount:"",//成本开始金额
        occurEndAmount:"",//成本结束金额
        costType: null,//成本类型
  ...
  methods: {
    ...
    validChange(v) {
      ...
      vm.$confirm(
        ...
        try {
          await costEffectiveness(vm.isValidParams);
    ...
    async fetchTableData() {
      ...
      try {
        ...
        let data = await costPage(vm.searchParams);
        console.log(data);
