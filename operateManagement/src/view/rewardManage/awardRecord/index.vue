<template>
  <div>
    <el-tabs type="border-card" v-model="targerName">
      <el-tab-pane label="奖励记录" name="first">
        <el-form
          class="dz-toolbar"
          ref="searchForm"
          :inline="true"
        ...
        <el-col :span="24">
          <div class="fr">
            <el-button type="primary" @click="createRewards" class="reateBtn" v-if="permButton('11030101')">创建奖励</el-button>
          </div>
        </el-col>
        <el-table border :data="tableData">
          <el-table-column label="奖励标题" :show-overflow-tooltip="true" width="180px" prop="title" align="center"></el-table-column>
          <el-table-column label="奖励来源" :show-overflow-tooltip="true" prop="organizationId" align="center">
            <template slot-scope="scope">
              {{scope.row.source.fullName}}
            </template>
          </el-table-column>
          <el-table-column label="奖励对象" :show-overflow-tooltip="true" prop="awardsPunishId" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column label="奖励原因" :show-overflow-tooltip="true" prop="cause" align="center"></el-table-column>
          <el-table-column label="奖励内容" :show-overflow-tooltip="true" prop="causeInfo" align="center"></el-table-column>
          <el-table-column label="奖励时间" :show-overflow-tooltip="true" prop="awardsPunishTime" align="center" width="150"></el-table-column>
          <el-table-column label="操作" width="250px" fixed="right" align="center">
            <template slot-scope="scope">
              <el-button size="small" type="text" @click="check(scope.row)" v-if="permButton('11030102')">查看</el-button>
              <el-button size="small" type="text" @click="update(scope.row)" v-if="permButton('11030103')">编辑</el-button>
...
import { rewardPage, rewardDel } from "@/api/rewardManage";
...
export default {
  ...
  methods: {
    ...
    async fetchTableData() {
      ...
      try {
        let data = await rewardPage(vm.searchParams)
